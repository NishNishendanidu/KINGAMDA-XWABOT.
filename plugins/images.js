...
if (Config.WORKTYPE == 'private') {
    ...
    badboy.addCommand({pattern: 'anime', fromMe: true, desc: 'random anime image'}, (async (message, match) => {
    ...
    badboy.addCommand({pattern: 'badboy', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
        
    var r_text = new Array ();    
r_text[0] = "\nEda eda, mandankonappi.. Nee enne kooduthal mandan aakkatheda\n";
r_text[1] = "badboyye tholpikkaan ningalkavilla. Jeevitathil badboyye tholpichittundu… palarum… palavattom…😥😥 aarellum aaa sed bgm onn iduo...";
r_text[2] = "badboy says i love you 😘";
r_text[3] = "badboyyude yudhangal Company Kanan Povunnatheyuloo";
...
r_text[8] = "\n enne vilicho...?🧐 \n";
r_text[9] = "ente per badboy ,ninte per donkey, backi ellarum monkey😼😼";
...
r_text[13] = ".song adich thangalude fav song name para badboy ath download aakki theraam";
...
r_text[21] = "Kochi pazhaya kochiyellennariyam… pakshe badboy pazhaya badboy thanneya...😎\n\n";
r_text[22] = "Kaanaan oru look illanney ullu… bhayankara budhiya\n\n ninnak allatto enik badboyk";
r_text[23] = "Ithalla ithinapparam chaadi kadannavananee K.K. badboy";
...
await message.sendMessage(r_text[i]);
    ...
    badboy.addCommand({pattern: 'anime', fromMe: false, desc:'random anime image '}, (async (message, match) => {
    ...
    badboy.addCommand({pattern: 'wallpaper', fromMe: false, desc: Lang.WP}, (async (message, match) => {
    ...
    badboy.addCommand({pattern: 'badboy', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
...
r_text[17] = "\n hey mishter ningalude per entha..?";
r_text[18] = "enikk njan und badboy uyir";
r_text[19] = "\n eda sathyam para nee ente fan alle..\n ";
r_text[20] = "The coefficient's of linear expansions is the position of Haemoglobin in the atmosphere. But Why? Full Many gem of purests serene lay underneath the unfathomed ocean's unblossomeds ! But why? But why";
r_text[21] = "Kochi pazhaya kochiyellennariyam… pakshe badboy pazhaya badboy thanneya...😎\n\n";
r_text[22] = "Kaanaan oru look illanney ullu… bhayankara budhiya\n\n ninnak allatto enik badboyk";
