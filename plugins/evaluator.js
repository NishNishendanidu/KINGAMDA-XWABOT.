...
var plk9 = ''
 ...
 if (Config.LANG == 'ML') {
         plk1 = '```എല്ലാ കമാൻഡുകളും ലഭിക്കാൻ .badboy ടൈപ്പ് ചെയ്യുക```'
         plk2 = 'എന്റെ പേര്'
         ...
         plk9 = ' ask my owner wa.me//+919645697828 '
      }//afnanplk creation
    else {
        plk1 = 'ᴛᴏ ɢᴇᴛ ᴀʟʟ ᴄᴏᴍᴍᴀɴᴅꜱ ᴛʏᴘᴇ .ʙᴀᴅʙᴏʏ'
        plk2 = 'hey am '
        ...
        plk9 = ' ask my owner wa.me//916282185054 '
    }  
...
MyPnky.addCommand({on: 'text', fromMe: false,onlyGroup: true, deleteCommand: false}, (async (message, match) => {
   ...
   await message.client.sendMessage(message.jid,badboy.OA_REPLY, MessageType.text, {quoted: message.data })
        }      
   }
}));
