...
Asena.addCommand({ pattern: 'badbot ?(.*)', fromMe: false, desc: 'word image' }, (async (message, match) => {
    ...
    await message.client.sendMessage(message.jid,Buffer.from(ttinullimage.data), MessageType.image, { mimetype: Mimetype.jpg, caption: '```Take this vro🤗```' })
